  ...
  "errors":[
    {
      ...
      "title":"max_node_count for test-ng is invalid (min_node_count (100) should be less or equal to max_node_count (3))",
      "detail":"max_node_count for test-ng is invalid (min_node_count (100) should be less or equal to max_node_count (3)).",
      "request_id":""
    }
  ]
}`
